...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Chanel No.5</h1>
      <p><strong>El perfume eterno de la elegancia</strong></p>
      <p>Perfume icónico que revolucionó la historia de la perfumería y se convirtió en el símbolo absoluto de la feminidad moderna.</p>
      <p>Fragancia inconfundible que atraviesa generaciones y permanece como la esencia del lujo atemporal.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="400 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.1,200">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/chanelcoco1.png" alt="Imagen 1">
          <img src="img/chanelcoco2.png" alt="Imagen 2">
          <img src="img/chanelcoco3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Chanel No.5",
        descripcion: "El perfume eterno de la elegancia",
        cantidad: 1,
        precio: 1200.00,
