...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Coach</h1>
      <p><strong>La esencia de la mujer urbana y libre</strong></p>
      <p>la autenticidad, la elegancia y la libertad</p>
      <p>Una fragancia moderna que combina la sofisticación con un espíritu joven y espontáneo.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="950 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.899">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          ...
          <img src="img/coach2.png" alt="Imagen 2">
          <img src="img/coach3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Coach",
        descripcion: "La esencia de la mujer urbana y libre",
        cantidad: 1,
        precio: 899.00,
