...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Yves Saint Laurent Eau de Parfum</h1>
      <p><strong>La elegancia como esencia. La audacia que deja huella.</strong></p>
      <p>Descubre YSL Eau de Parfum: una fragancia creada para el hombre moderno, seguro de sí mismo y con un estilo distintivo.</p>
      <p>Notas frescas de bergamota y jengibre se combinan con la calidez de la madera y el toque sensual del almizcle, dejando una estela sofisticada, intensa y memorable..</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="150 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 1,699.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/yves saint carru 1.webp" alt="Imagen 1">
          <img src="img/yves saint carru 2.jpg" alt="Imagen 2">
          <img src="img/yves sain carru 3.jpg" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  function agregarAlCarrito() {
    const producto = {
      nombre: "Yves Saint Laurent Eau de Parfum",
      descripcion: "La elegancia como esencia. La audacia que deja huella.",
      cantidad: 1,
      precio: 1699.00,
