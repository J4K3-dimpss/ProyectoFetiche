...
<body>
  <div class="container">
    <div class="left-column">
      ...
      <p><strong>La frescura de un ramo floral en primavera</strong></p>
      <p>una fragancia delicada y luminosa que captura la poesía de las flores recién abiertas.</p>
      <p>Uun perfume tan fresco y radiante como una caricia floral.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="1200 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.879">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/coach1.png" alt="Imagen 1">
          <img src="img/blooming2.png" alt="Imagen 2">
          <img src="img/blooming3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Blooming Bouquet",
        descripcion: "La frescura de un ramo floral en primavera",
        cantidad: 1,
        precio: 879.00,
