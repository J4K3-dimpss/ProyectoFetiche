...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Hollister California</h1>
      <p><strong>La frescura como esencia. El espíritu libre de la costa oeste.</strong></p>
      <p>Sumérgete en el universo Hollister California: una fragancia inspirada en la playa, el sol y la brisa del océano.</p>
      <p>Aromas que combinan notas cítricas y frutales con toques marinos, equilibrados por maderas suaves que dejan una estela ligera, fresca y llena de energía juvenil.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="65 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 539.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/Hollister california.png" alt="Imagen 1">
          <img src="img/Hollister carru 2.png" alt="Imagen 2">
          <img src="img/hollister carru 3.jpg" alt="Imagen 3">
        </div>
...
<script>
  ...
  function agregarAlCarrito() {
    const producto = {
      nombre: "Hollister California",
      descripcion: "La frescura como esencia. El espíritu libre de la costa oeste.",
      cantidad: 1,
      precio: 539.00,
