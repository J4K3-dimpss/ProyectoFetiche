...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Versace Eros Eau de Parfum</h1>
      <p><strong>La pasión como esencia. El poder hecho fragancia.</strong></p>
      <p>Descubre Eros Eau de Parfum: un aroma que encarna la fuerza del deseo y la confianza masculina.</p>
      <p>Notas vibrantes de menta y limón se fusionan con la calidez de la vainilla y la profundidad del cedro, dejando una estela intensa, seductora y absolutamente inolvidable.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="110 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 1,399.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/Versace carru 2.jpg" alt="Imagen 1">
          <img src="img/versace carru 1.jpg" alt="Imagen 2">
          <img src="img/versace carru 3.webp" alt="Imagen 3">
        </div>
...
<script>
  ...
  function agregarAlCarrito() {
    const producto = {
      ...
      descripcion: "La pasión como esencia. El poder hecho fragancia.",
      cantidad: 1,
      precio: 1399.00,
