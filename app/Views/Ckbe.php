...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Calvin Klein Be</h1>
      <p><strong>La libertad como esencia. La autenticidad en cada respiro.</strong></p>
      <p>Descubre CK Be: una fragancia minimalista y universal, creada para quienes se atreven a ser ellos mismos.</p>
      <p>Notas frescas de bergamota y menta se fusionan con la suavidad del almizcle y la calidez de la madera, dejando una estela limpia, íntima y atemporal.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="70 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 625.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/ck be carru 1.webp" alt="Imagen 1">
          <img src="img/Ck be carru.webp" alt="Imagen 2">
          <img src="img/ck be carru 2.webp" alt="Imagen 3">
        </div>
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        ...
        descripcion: "La libertad como esencia. La autenticidad en cada respiro.",
        cantidad: 1,
        precio: 625.00,
