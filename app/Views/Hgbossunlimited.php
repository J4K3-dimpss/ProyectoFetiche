...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Hugo Boss Unlimited</h1>
      <p><strong>La libertad como esencia. La energía que inspira cada momento.</strong></p>
      <p>Descubre Unlimited: una fragancia diseñada para el hombre audaz, lleno de vitalidad y espíritu libre.</p>
      <p>Notas frescas de cítricos y jengibre se mezclan con la intensidad de la madera y un toque de almizcle, dejando una estela vibrante, moderna y llena de dinamismo.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="35 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 1,099.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/hg boss unli carru 2.jpg" alt="Imagen 1">
          <img src="img/hg boss unli carru 1.png" alt="Imagen 2">
          <img src="img/hg boss unli carru 3.webp" alt="Imagen 3">
        </div>
...
<script>
  ...
  function agregarAlCarrito() {
    const producto = {
      ...
      descripcion: "La libertad como esencia. La energía que inspira cada momento.",
      cantidad: 1,
      precio: 1099.00,
