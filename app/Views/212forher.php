...
<body>
  <div class="container">
    <div class="left-column">
      <h1>212 Heroes For Her</h1>
      <p><strong>La fragancia de la juventud eterna</strong></p>
      <p>Un tributo a la autenticidad, la libertad y la energía imparable de una nueva generación de mujeres.</p>
      <p>Fragancia femenina y vibrante que celebra el poder de ser uno mismo, sin reglas ni límites..</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="749 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.649">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/212forher1.png" alt="Imagen 1">
          <img src="img/212forher2.png" alt="Imagen 2">
          <img src="img/212forher3.png" alt="Imagen 3">
        </div>
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "212 Heroes For Her",
        descripcion: "La fragancia de la juventud eterna",
        cantidad: 1,
        precio: 649.00,
