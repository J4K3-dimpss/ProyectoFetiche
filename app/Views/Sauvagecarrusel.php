...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Sauvage Dior Eau De Parfum</h1>
      <p><strong>La fuerza como esencia. La libertad como firma.</strong></p>
      <p>Adéntrate en el mundo de Sauvage: una declaración de carácter salvaje, magnético y eterno.</p>
      <p>Una fragancia que envuelve con la intensidad del ámbar, sorprende con la frescura cítrica de la bergamota y deja una estela inolvidable.</p>
      ...
      <div class="product-info">
        ...
        <input type="text" id="price" value="Q 1,599.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/Sauvage dior carrusel 1.jpg" alt="Imagen 1">
          <img src="img/Sauvage carrusel 2.webp" alt="Imagen 2">
          <img src="img/sauvage carrusel 3.webp" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Sauvage Dior Eau De Parfum",
        descripcion: "La fuerza como esencia. La libertad como firma.",
        cantidad: 1,
        precio: 1599.00,
