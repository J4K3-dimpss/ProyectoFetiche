...
<body>
  <div class="container">
    <div class="left-column">
      <h1>J'adore Infinissime</h1>
      <p><strong>La esencia de la feminidad infinita</strong></p>
      <p>Una fragancia floral infinita que transforma cada instante en una declaración de poder y sofisticación.</p>
      <p>El icónico frasco de curvas doradas, símbolo eterno de lujo y deseo, guarda en su interior un aroma que se despliega sin fin: intenso, seductor y absolutamente inolvidable.ín, y deja una estela inolvidable de rosa centifolia.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="300 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.900">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/envy1.png" alt="Imagen 1">
          <img src="img/envy2.png" alt="Imagen 2">
          <img src="img/envy3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "J'adore Infinissime",
        descripcion: "La esencia de la feminidad infinita",
        cantidad: 1,
        precio: 900.00,
