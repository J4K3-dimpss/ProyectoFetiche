...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Hugo Boss Bottled Night</h1>
      <p><strong>La ambición como esencia. La seducción en su máxima expresión.</strong></p>
      <p>Descubre Bottled Night: una fragancia creada para el hombre seguro de sí mismo, que conquista con su presencia magnética.</p>
      <p>Notas frescas de lavanda y abedul se combinan con la intensidad del almizcle y maderas oscuras, dejando una estela profunda, elegante y cautivadora.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="55 perfumes en existencia">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/Hg bottled night carru 1.jpg" alt="Imagen 1">
          <img src="img/Hg bottled night carru 2.webp" alt="Imagen 2">
          <img src="img/hg bottled night carru 3.jpeg" alt="Imagen 3">
        </div>
...
<script>
  ...
  function agregarAlCarrito() {
    const producto = {
      ...
      descripcion: "La ambición como esencia. La seducción en su máxima expresión.",
      cantidad: 1,
      precio: 899.00,
