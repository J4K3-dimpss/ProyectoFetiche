...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Rose des Vent</h1>
      <p><strong>El viaje eterno de una rosa</strong></p>
      <p>Es una oda a la feminidad radiante y al poder evocador de la rosa, la flor eterna de la perfumería.</p>
      <p>Esta fragancia mezcla delicadeza y sofisticación con un espíritu libre.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="1,790 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.2,300">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/rose1.png" alt="Imagen 1">
          <img src="img/rose2.png" alt="Imagen 2">
          <img src="img/rose3.png   " alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Rose des Vent",
        descripcion: "El viaje eterno de una rosa",
        cantidad: 1,
        precio: 2300.00,
