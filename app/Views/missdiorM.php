...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Miss Dior</h1>
      <p><strong>El arte de amar la vida</strong></p>
      <p>Una invitación a ver el mundo con alegría, pasión y romanticismo.</p>
      <p>Una fragancia floral que despierta los sentidos y acaricia el alma con su delicadeza y frescura.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="600 perfumes en existencia">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/missdiorM1.png" alt="Imagen 1">
          <img src="img/missdiorM2.png" alt="Imagen 2">
          <img src="img/missdiorM3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Miss Dior",
        descripcion: "El arte de amar la vida",
        cantidad: 1,
        precio: 900.00,
