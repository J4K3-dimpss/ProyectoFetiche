  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?= base_url('index2') ?>">Inicio</a>
        </li>
      </ul>
...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Polo Live L´bel</h1>
      <p><strong>La energía como esencia. La autenticidad que te define.</strong></p>
      <p>Adéntrate en el mundo de Polo Live: una declaración de vitalidad, frescura y confianza.</p>
      <p>Una fragancia que envuelve con notas cítricas vibrantes, impulsa con la fuerza aromática de las hierbas y deja una estela inolvidable de maderas modernas y masculinas.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="100 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 499.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/Polo lbel.png" alt="Imagen 1">
          <img src="img/polo lbel carru 2.jpg" alt="Imagen 2">
          <img src="img/polo lbel carru 3.jpg" alt="Imagen 3">
        </div>
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Polo Live L´bel",
        descripcion: "La energía como esencia. La autenticidad que te define.",
        cantidad: 1,
        precio: 499.00,
        tienda: "23 calle 10-30 zona 4 de Mixco, Ciudad de Guatemala 01057, Guatemala",
        categoria: "Masculino"
      };
      // Guardar en localStorage (puedes usar sessionStorage si prefieres)
    ...
    function mostrarFactura() {
      ...
      // Limpia el carrito después de mostrar la factura
