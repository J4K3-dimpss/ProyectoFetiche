...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Miss Dior Le Parfum Dior</h1>
      <p><strong>El amor como perfume. La pasión como firma.</strong></p>
      <p>Entra en el mundo de Miss Dior Le Parfum: una declaración de amor intensa, audaz y eterna.</p>
      <p>Una fragancia que envuelve con la calidez del ámbar, acaricia con la elegancia del jazmín, y deja una estela inolvidable de rosa centifolia.</p>
      ...
      <div class="product-info">
        ...
        <input type="text" id="price" value="Q.299.97">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/missdior1.webp" alt="Imagen 1">
          <img src="img/missdior2.png" alt="Imagen 2">
          <img src="img/missdior3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Miss Dior Le Parfum Dior",
        descripcion: "El amor como perfume. La pasión como firma.",
        cantidad: 1,
        precio: 299.97,
