...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Aqua Allegoria Forte Patchouli Ardent</h1>
      <p><strong>Intensidad que despierta los sentidos</strong></p>
      <p>Es una fragancia cálida, sofisticada y luminosa que rinde homenaje a la nobleza del pachulí, reinventado con un toque contemporáneo.</p>
      <p>con su diseño dorado en panal de abeja, refleja la riqueza de la naturaleza y la tradición de la Maison Guerlain, en un tributo a la elegancia eterna.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="700 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.1,699">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/ardent1.png" alt="Imagen 1">
          <img src="img/ardent2.png" alt="Imagen 2">
          <img src="img/ardent3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Aqua Allegoria Forte Patchouli Ardent",
        descripcion: "Intensidad que despierta los sentidos",
        cantidad: 1,
        precio: 1699.00,
