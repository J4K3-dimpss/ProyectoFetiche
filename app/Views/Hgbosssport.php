...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Hugo Boss Bottled Sport</h1>
      <p><strong>La energía como esencia. El impulso para superar cada reto.</strong></p>
      <p>Explora Bottled Sport: una fragancia diseñada para el hombre activo, decidido y con espíritu competitivo.</p>
      <p>Notas vibrantes de toronja y aldehídos se mezclan con la frescura del cardamomo y la intensidad del vetiver, dejando una estela revitalizante, dinámica y llena de fuerza.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="30 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 749.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/hg sport carru 1.jpg" alt="Imagen 1">
          <img src="img/hg-sport carru2.jpg" alt="Imagen 2">
          <img src="img/hg sport carru 4.avif" alt="Imagen 3">
        </div>
...
<script>
  ...
  function agregarAlCarrito() {
    const producto = {
      nombre: "Hugo Boss Bottled Sport",
      descripcion: "La energía como esencia. El impulso para superar cada reto.",
      cantidad: 1,
      precio: 749.00,
