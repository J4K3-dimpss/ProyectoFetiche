...
<body>
  <div class="container">
    <div class="left-column">
      <h1>My Burberry</h1>
      <p><strong>La esencia de un jardín londinense tras la lluvia</strong></p>
      <p>La elegancia clásica de Londres y la frescura de sus jardines después de una suave lluvia.</p>
      <p>Una fragancia sofisticada y atemporal que viste la piel con estilo y naturalidad.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="1,000 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.1,899">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/mybureberry1.png" alt="Imagen 1">
          <img src="img/myburberry2.png" alt="Imagen 2">
          <img src="img/myburberry3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "My Burberry",
        descripcion: "La esencia de un jardín londinense tras la lluvia",
        cantidad: 1,
        precio: 1899.00,
