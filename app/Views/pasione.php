...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Sí Passione</h1>
      <p><strong>La fuerza de decir “sí”</strong></p>
      <p>Es una fragancia intensa y envolvente que celebra la valentía, la libertad y la pasión de la mujer moderna.</p>
      <p>Un perfume que combina la delicadeza con la fuerza, invitando a vivir la vida con emoción y sin miedo.</p>
      
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="500 perfumes en existencia">

        <label for="price">Precio</label>
        <input type="text" id="price" value="Q.1,599">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/pasione1.png" alt="Imagen 1">
          <img src="img/pasione2.png" alt="Imagen 2">
          <img src="img/pasione3.png" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Sí Passione",
        descripcion: "La fuerza de decir “sí”",
        cantidad: 1,
        precio: 1599.00,
