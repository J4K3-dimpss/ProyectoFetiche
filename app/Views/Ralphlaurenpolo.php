...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Ralph Lauren Polo Black</h1>
      <p><strong>La seducción como esencia. La sofisticación en cada detalle.</strong></p>
      <p>Descubre Polo Black: una fragancia moderna y atrevida, creada para el hombre que irradia confianza y estilo.</p>
      <p>Notas frescas de mango helado y salvia se mezclan con la intensidad de la madera de sándalo y el pachulí, dejando una estela elegante, magnética e inolvidable.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="80 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 999.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/ralph lauren polo back.png" alt="Imagen 1">
          <img src="img/ralph lauren carru 2.webp" alt="Imagen 2">
          <img src="img/ralph lauren carru 3.webp" alt="Imagen 3">
        </div>
...
<div id="facturaModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.5); z-index:9999; align-items:center; justify-content:center;">
  ...
  <script>
    ...
    function agregarAlCarrito() {
      const producto = {
        nombre: "Ralph Lauren Polo Black",
        descripcion: "La seducción como esencia. La sofisticación en cada detalle.",
        cantidad: 1,
        precio: 999.00,
