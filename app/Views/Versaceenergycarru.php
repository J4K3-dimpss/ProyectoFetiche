...
<body>
  <div class="container">
    <div class="left-column">
      <h1>Versace Eros Energy</h1>
      <p><strong>La vitalidad como esencia. La fuerza que despierta los sentidos.</strong></p>
      <p>Descubre Eros Energy: una fragancia diseñada para el hombre audaz, enérgico y lleno de pasión.</p>
      <p>Notas cítricas de limón y pomelo se mezclan con la frescura de la menta y la intensidad de la madera de cedro, dejando una estela vibrante, potente y memorable.</p>
     
      <div class="product-info">
        <label for="stock">Registros del producto</label>
        <input type="text" id="stock" value="45 perfumes en existencia">
 
        <label for="price">Precio</label>
        <input type="text" id="price" value="Q 899.00">
    ...
    <div class="right-column">
      <div class="carousel">
        <div class="carousel-images" id="carouselImages">
          <img src="img/versce energy carru 1.webp" alt="Imagen 1">
          <img src="img/versace energy carru 2.webp" alt="Imagen 2">
          <img src="img/Versace energy carru 3.jpg" alt="Imagen 3">
        </div>
...
<script>
  ...
  function agregarAlCarrito() {
    const producto = {
      nombre: "Versace Eros Energy",
      descripcion: "La vitalidad como esencia. La fuerza que despierta los sentidos.",
      cantidad: 1,
      precio: 899.00,
